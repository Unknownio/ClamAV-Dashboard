...
class MainWindow(QMainWindow):
    ...
    def _build_sidebar(self):
        ...
        name_col.addWidget(label("ClamAV Web UI Client", 14, "bold"))
        v = label("", 9, color=TEXT_SEC)
        v.setStyleSheet(f"color: {TEXT_SEC}; letter-spacing: 1px; background: transparent;")
        name_col.addWidget(v)
